...
class ProductItem extends GetView<SearchPageController> {
  final int index;
  ProductItem({super.key, required this.index});

  @override
  Widget build(BuildContext context) {
    final ProductsCardSearchEntite product = controller.productsPagingController.itemList == null ? ProductsCardSearchEntite(id: 0 , categoryId: '0' , image: 'Image' , marketName: 'MarketName',name: "Name" , price: 100) : controller.productsPagingController.itemList![index];
    return Padding(
